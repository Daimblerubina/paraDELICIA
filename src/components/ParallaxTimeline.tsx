...
export default function ParallaxTimeline() {
  ...
  const photoItems: PhotoItem[] = Array.from({ length: loveConfig.photoCount }, (_, i) => ({
    ...
    milestone: loveConfig.milestones[i] || {
      title: 'Hermoso Recuerdo',
      date: 'Nuestro viaje juntos',
      description: 'Cada momento contigo es un tesoro especial.'
    },
    index: i
  }));
    ...
    <section className={styles.timeline}>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p>Cada momento, un capítulo de nuestro hermoso viaje juntos</p>
        </div>
