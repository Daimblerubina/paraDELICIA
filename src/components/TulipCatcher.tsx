    ...
    <section className={styles.gameSection}>
      <div className={styles.container}>
        <div className={styles.gameHeader}>
          <h2>Un pequeño juego para ti🌷</h2>
          <p>Atrapar {TARGET_SCORE} Tulipanes que caen para revelar algo especial!</p>
        </div>
          ...
          <div className={styles.startScreen}>
            <div className={styles.startCard}>
              ...
              <ul className={styles.instructions}>
                <li>🌷 Toca los tulipanes caen para atraparlos.</li>
                <li>🎯 Atrapar {TARGET_SCORE} tulipanes para ganar</li>
                <li>⏱️ ¡No las dejes caer de la pantalla!</li>
              </ul>
            ...
            <div className={styles.gameArea} ref={gameAreaRef}>
              ...
              {tulips.length === 0 && (
                <div className={styles.waitingMessage}>
                  ¡Prepárate! Los tulipanes están llegando... 🌷
                </div>
              )}
            </div>
          </>
