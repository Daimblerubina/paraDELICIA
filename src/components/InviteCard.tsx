...
export default function InviteCard({ onPlayAgain }: InviteCardProps) {
  ...
  const handleYesClick = () => {
    ...
    alert('🎉 wii! sabia que dirias que si... \'deseo celebrarlo contigo!! 💕');
  };

  const handleNoClick = () => {
    // Optional: Show a sad message or do nothing
    console.log('Intentando hacer clic en No... 😏');
  };
  ...
  const handleAddToCalendar = () => {
    ...
    const event = {
      title: `Día de San Valentín con ${loveConfig.yourName}`,
      description: loveConfig.inviteMessage,
      location: loveConfig.inviteLocation,
      startDate: new Date(loveConfig.valentineDate + 'T20:00:00-05:00'), // 7:00 PM Singapore time
      endDate: new Date(loveConfig.valentineDate + 'T00:00:00-05:00'),
    };
